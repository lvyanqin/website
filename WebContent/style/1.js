            ...
            if (!isPre && product.length) {
                ...
                function count_product() {
                    ...
                    if (express_fee > 0 && !no_express) {
                        ...
                        html += '<div style="text-align:right">包邮</div>';
                        express_fee = 0;
                    }
                    ...
                    // 地址填写表单
                    html += '<form><div class="panel panel-concise"><div class="panel-heading">收货地址 <span class="f12 c999">(<span style="color:red">*</span>为必填项)</span></div><div class="panel-body">\
                            ...
                            <div class="form-group clearfix">\
                                <label class="do-col-2 align-right control-label">邮箱 <span style="color:red">*</span></label>\
                                <div class="do-col-10"><input required="true" type="email" class="form-control" name="forms_product_address[email]" placeholder="请输入邮箱" value="' + vm.formsCustomerAddress.email + '"></div>\
                            </div>\
                            <div class="form-group clearfix">\
                            ...
                            <div class="form-group clearfix form-area">\
                ...
                vm.payConfirm = layer.confirm(count_product(), {
                    ...
                    btn2: function(index, layero) {
                        ...
                        if (vm.formsCustomerAddress.email == "" || !(/^(\w-*\.*)+@(\w-?)+(\.\w{2,})+$/.test(vm.formsCustomerAddress.email))) {
                                ...
                                $.getJSON('/sites/' + response.order.siteid + '/onlinePayPlatform', function(data) {
                                    ...
                                    layer.confirm(text, {
                                        ...
                                        btn2: function(index, layero) {
                                            ...
                                            layer.confirm('订单是否支付成功？支付成功我们将尽快为您【发货或者联系您】', {
                                                title: '提示',
                                                move: false,
                                                closeBtn: 0,
                                                skin: 'layer-btnRight',
